...
exports.Textfield = function (_a) {
    var _b = _a.title, title = _b === void 0 ? "" : _b, _c = _a.value, value = _c === void 0 ? "" : _c, _d = _a.placeholder, placeholder = _d === void 0 ? "" : _d, _e = _a.type, type = _e === void 0 ? "text" : _e, _f = _a.disabled, disabled = _f === void 0 ? false : _f, _g = _a.onChange, onChange = _g === void 0 ? function () { return null; } : _g, _h = _a.dataTest, dataTest = _h === void 0 ? false : _h;
    ...
    react_1.default.createElement("div", { style: { opacity: disabled ? 0.5 : 1 }, "data-test": dataTest },
