...
exports.Code = function (_a) {
    ...
    var _g = contexts_1.useTheme(), colors = _g.colors, codeSizes = _g.codeSizes, fontWeights = _g.fontWeights, lineHeights = _g.lineHeights;
    return (react_1.default.createElement("code", { style: {
            display: "block",
